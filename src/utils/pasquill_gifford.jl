...
"""
function crosswind_dispersion(x::Number, ::Type{ClassA}, ::Type{Defaultσy}; avg_time=600.0)
    δ, β, tₐ = 0.423, 0.9, 18.4
    δ = δ*(max(avg_time, tₐ)/600)^0.2
    return δ*x^β
end

function crosswind_dispersion(x::Number, ::Type{ClassB}, ::Type{Defaultσy}; avg_time=600.0)
    δ, β, tₐ = 0.313, 0.9, 18.4
    δ = δ*(max(avg_time, tₐ)/600)^0.2
    return δ*x^β
end

function crosswind_dispersion(x::Number, ::Type{ClassC}, ::Type{Defaultσy}; avg_time=600.0)
    δ, β, tₐ = 0.210, 0.9, 18.4
    δ = δ*(max(avg_time, tₐ)/600)^0.2
    return δ*x^β
end

function crosswind_dispersion(x::Number, ::Type{ClassD}, ::Type{Defaultσy}; avg_time=600.0)
    δ, β, tₐ = 0.136, 0.9, 18.3
    δ = δ*(max(avg_time, tₐ)/600)^0.2
    return δ*x^β
end

function crosswind_dispersion(x::Number, ::Type{ClassE}, ::Type{Defaultσy}; avg_time=600.0)
    δ, β, tₐ = 0.102, 0.9, 11.4
    δ = δ*(max(avg_time, tₐ)/600)^0.2
    return δ*x^β
end

function crosswind_dispersion(x::Number, ::Type{ClassF}, ::Type{Defaultσy}; avg_time=600.0)
...
"""
function vertical_dispersion(x::Number, ::Type{ClassA}, ::Type{Defaultσz})
    δ = 107.7
    β = -1.7172
    γ = 0.2770
...
function vertical_dispersion(x::Number, ::Type{ClassB}, ::Type{Defaultσz})
    δ=0.1355
    β=0.8752
    γ=0.0136
    return δ*(x^β)*exp(γ*log(x)^2)
...
function vertical_dispersion(x::Number, ::Type{ClassC}, ::Type{Defaultσz})
    δ=0.09623
    β=0.9477
    γ=-0.0020
    return δ*(x^β)*exp(γ*log(x)^2)
...
function vertical_dispersion(x::Number, ::Type{ClassD}, ::Type{Defaultσz})
    δ=0.04134
    β=1.1737
    γ=-0.0316
    return δ*(x^β)*exp(γ*log(x)^2)
...
function vertical_dispersion(x::Number, ::Type{ClassE}, ::Type{Defaultσz})
    δ=0.02275
    β=1.3010
    γ=-0.0450
    return δ*(x^β)*exp(γ*log(x)^2)
...
function vertical_dispersion(x::Number, ::Type{ClassF}, ::Type{Defaultσz})
    δ=0.01122
    β=1.4024
    γ=-0.0540
    return δ*(x^β)*exp(γ*log(x)^2)
...
"""
crosswind_dispersion(x::Number, ::Type{ClassA}, ::Type{CCPSPuffσy}) = 0.18*x^0.92
crosswind_dispersion(x::Number, ::Type{ClassB}, ::Type{CCPSPuffσy}) = 0.14*x^0.92
crosswind_dispersion(x::Number, ::Type{ClassC}, ::Type{CCPSPuffσy}) = 0.10*x^0.92
crosswind_dispersion(x::Number, ::Type{ClassD}, ::Type{CCPSPuffσy}) = 0.06*x^0.92
crosswind_dispersion(x::Number, ::Type{ClassE}, ::Type{CCPSPuffσy}) = 0.04*x^0.92
crosswind_dispersion(x::Number, ::Type{ClassF}, ::Type{CCPSPuffσy}) = 0.02*x^0.89
