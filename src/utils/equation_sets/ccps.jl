...
"""
_windspeed(u0::Number,z0::Number,z::Number,::Type{ClassA},::CCPSRural) = u0*(z/z0)^0.07
_windspeed(u0::Number,z0::Number,z::Number,::Type{ClassB},::CCPSRural) = u0*(z/z0)^0.07
...
+ AIChE/CCPS. 1999. *Guidelines for Consequence Analysis of Chemical Releases*. New York: American Institute of Chemical Engineers
"""
_windspeed(u0::Number,z0::Number,z::Number,::Type{ClassA},::CCPSUrban) = u0*(z/z0)^0.15
_windspeed(u0::Number,z0::Number,z::Number,::Type{ClassB},::CCPSUrban) = u0*(z/z0)^0.15
...
+ Griffiths, R. F. 1994. "Errors in the use of the Briggs parameterization for atmospheric dispersion coefficients." *Atmospheric Environment* 28(17):2861-2865 https://doi.org/10.1016/1352-2310(94)90086-8
"""
crosswind_dispersion(x::Number, ::Type{Plume}, ::Type{ClassA}, ::CCPSUrban) = 0.32x/√(1+0.0004x)
crosswind_dispersion(x::Number, ::Type{Plume}, ::Type{ClassB}, ::CCPSUrban) = 0.32x/√(1+0.0004x)
...
crosswind_dispersion(x::Number, ::Type{Plume}, ::Type{ClassE}, ::CCPSUrban) = 0.11x/√(1+0.0004x)
crosswind_dispersion(x::Number, ::Type{Plume}, ::Type{ClassF}, ::CCPSUrban) = 0.11x/√(1+0.0004x)
...
+ Griffiths, R. F. 1994. "Errors in the use of the Briggs parameterization for atmospheric dispersion coefficients." *Atmospheric Environment* 28(17):2861-2865 https://doi.org/10.1016/1352-2310(94)90086-8
"""
vertical_dispersion(x::Number, ::Type{Plume}, ::Type{ClassA}, ::CCPSUrban) = 0.24x*√(1+0.001x)
vertical_dispersion(x::Number, ::Type{Plume}, ::Type{ClassB}, ::CCPSUrban) = 0.24x*√(1+0.001x)
...
vertical_dispersion(x::Number, ::Type{Plume}, ::Type{ClassE}, ::CCPSUrban) = 0.08x/√(1+0.0015x)
vertical_dispersion(x::Number, ::Type{Plume}, ::Type{ClassF}, ::CCPSUrban) = 0.08x/√(1+0.0015x)
