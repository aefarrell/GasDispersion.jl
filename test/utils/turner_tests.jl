@testset "Turner 1970 Equation Sets" begin
    ...
    @testset "Pasquill-Gifford dispersion tests" begin
        ...
        @testset "Plume dispersion, stability class $class" for (class,sy,sz1,sz2,sz3,sz4) in known
            @test GasDispersion.crosswind_dispersion(1.2, class, Turner()) ≈ sy
            @test GasDispersion.vertical_dispersion(1.2, class, Turner()) ≈ sz1
            @test GasDispersion.vertical_dispersion(120, class, Turner()) ≈ sz2
            @test GasDispersion.vertical_dispersion(520, class, Turner()) ≈ sz3
            @test GasDispersion.vertical_dispersion(1e6, class, Turner()) ≈ sz4
        end
