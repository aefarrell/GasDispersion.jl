@testset "Scenario Builder tests" begin
    ...
    a = SimpleAtmosphere()
    s1 = Substance(name="test liquid", vapor_pressure=0, gas_density=0, liquid_density=490,
    ...
    s2 = Substance(name="test gas",vapor_pressure=0,gas_density=8.90,liquid_density=0,
