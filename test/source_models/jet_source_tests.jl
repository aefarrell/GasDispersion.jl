@testset "Scenario Builder tests" begin
    ...
    a = SimpleAtmosphere()
    s1 = Substance(name="test liquid", gas_density=0, liquid_density=490,
         boiling_temp=0,latent_heat=0,gas_heat_capacity=0,
    ...
    s2 = Substance(name="test gas",gas_density=8.90,liquid_density=0,
         reference_temp=298,reference_pressure=501e3,boiling_temp=0,
    ...
    gjet = Scenario(s2, HorizontalJet(mass_rate=0.09002799947040846,duration=Inf,
            ...
            fraction_liquid = 0),a)
    @test gjet ≈ scenario_builder(s2,JetSource,a;phase=:gas,dischargecoef=0.85,k=1.15,diameter=0.01,pressure=501e3,temperature=298,height=1)
